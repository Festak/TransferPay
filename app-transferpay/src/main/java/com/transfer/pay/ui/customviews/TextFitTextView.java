...
public class TextFitTextView extends TextView {
    ...
    public void resizeText(int width, int height) {
        ...
        if (mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
            ...
            StaticLayout layout = new StaticLayout(text, paint, width, Layout.Alignment.ALIGN_NORMAL, mSpacingMulti, mSpacingAdd, false);
    ...
    private int getTextHeight(CharSequence source, TextPaint paint, int width, float textSize) {
        ...
        StaticLayout layout = new StaticLayout(source, paintCopy, width, Layout.Alignment.ALIGN_NORMAL, mSpacingMulti, mSpacingAdd, true);
