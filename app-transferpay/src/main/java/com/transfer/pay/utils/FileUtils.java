...
import com.transfer.pay.utils.bitmap.BitmapFactoryOptionsSettings;
import com.transfer.pay.utils.bitmap.PngUtils;
...
public class FileUtils {
    ...
    public static final String LOGO_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/Remittance/Logos/";
    public static final String SCAN_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/Remittance/Scans/";
    public static final String JSON_PATH = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() + "/Remittance/Json/";
    ...
    public static void writeBitmapToFile(String filePath, String fileName, Bitmap bitmap) {
